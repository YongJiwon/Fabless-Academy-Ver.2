...
HD_PWD='D:/Work/OnDeviceAI2/0413_Control_Unit_LED/0413_Control_Unit_LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_led_mealy.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsm_led_mealy.tcl -notrace
