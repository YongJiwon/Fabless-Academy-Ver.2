...
HD_PWD='D:/Work/OnDeviceAI2/0413_Control_Unit_LED/0413_Control_Unit_LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_led_mealy.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm_led_mealy.tcl
