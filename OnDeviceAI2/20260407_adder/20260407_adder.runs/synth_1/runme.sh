...
HD_PWD='D:/Work/OnDeviceAI2/20260407_adder/20260407_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_fnd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_fnd.tcl
