...
HD_PWD='D:/Work/OnDeviceAI2/20260407_adder/20260407_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_fnd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_fnd.tcl -notrace
