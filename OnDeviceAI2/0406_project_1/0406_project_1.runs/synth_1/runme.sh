...
HD_PWD='D:/Work/OnDeviceAI2/0406_project_1/0406_project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_gates.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_gates.tcl
