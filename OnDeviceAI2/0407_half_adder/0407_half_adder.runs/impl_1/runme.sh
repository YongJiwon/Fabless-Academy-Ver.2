...
HD_PWD='D:/Work/OnDeviceAI2/0407_half_adder/0407_half_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fnd_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fnd_controller.tcl -notrace
