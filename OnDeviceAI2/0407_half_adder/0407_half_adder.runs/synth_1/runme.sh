...
HD_PWD='D:/Work/OnDeviceAI2/0407_half_adder/0407_half_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fnd_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fnd_controller.tcl
