...
HD_PWD='D:/Work/OnDeviceAI2/0623_Prectice_Custom_IP/0623_Prectice_Custom_IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Stopwatch_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Stopwatch_design_wrapper.tcl
