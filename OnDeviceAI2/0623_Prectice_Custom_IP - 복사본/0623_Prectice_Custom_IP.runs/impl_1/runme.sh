...
HD_PWD='D:/Work/OnDeviceAI2/0623_Prectice_Custom_IP/0623_Prectice_Custom_IP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Stopwatch_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Stopwatch_design_wrapper.tcl -notrace
