...
HD_PWD='D:/Work/OnDeviceAI2/20260612_I2C_Master_practice/20260612_I2C_Master_practice.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_demo_count.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_demo_count.tcl -notrace
