...
HD_PWD='D:/Work/OnDeviceAI2/20260612_I2C_Master_practice/20260612_I2C_Master_practice.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_demo_count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_demo_count.tcl
