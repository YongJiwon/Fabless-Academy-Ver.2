...
HD_PWD='D:/Work/OnDeviceAI2/mk2/mk2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sw_sum_fnd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sw_sum_fnd.tcl
