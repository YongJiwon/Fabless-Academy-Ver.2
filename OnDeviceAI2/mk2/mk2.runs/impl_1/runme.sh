...
HD_PWD='D:/Work/OnDeviceAI2/mk2/mk2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sw_sum_fnd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sw_sum_fnd.tcl -notrace
