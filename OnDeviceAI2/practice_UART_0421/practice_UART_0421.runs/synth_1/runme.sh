...
HD_PWD='D:/Work/OnDeviceAI2/practice_UART_0421/practice_UART_0421.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_loopback.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_loopback.tcl
