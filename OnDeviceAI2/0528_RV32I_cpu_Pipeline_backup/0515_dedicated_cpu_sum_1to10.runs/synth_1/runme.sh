...
HD_PWD='D:/Work/OnDeviceAI2/0520_RV32I_cpu_Reg_File/0515_dedicated_cpu_sum_1to10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_rv32i_soc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_rv32i_soc.tcl
