...
HD_PWD='D:/Work/OnDeviceAI2/UART_Sensor/UART_Sensor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_uart_time_sensor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_uart_time_sensor.tcl
