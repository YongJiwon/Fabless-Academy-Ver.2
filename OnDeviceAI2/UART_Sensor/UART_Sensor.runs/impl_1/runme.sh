...
HD_PWD='D:/Work/OnDeviceAI2/UART_Sensor/UART_Sensor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_uart_time_sensor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_uart_time_sensor.tcl -notrace
