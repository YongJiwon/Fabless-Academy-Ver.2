...
HD_PWD='D:/Work/OnDeviceAI2/0615_I2C_SLAVE/0615_I2C_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log slave_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source slave_top.tcl
