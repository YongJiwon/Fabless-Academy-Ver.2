...
HD_PWD='D:/Work/OnDeviceAI2/260622_MicroBlaze_GPIO/260622_MicroBlaze_GPIO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GPIO_Test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GPIO_Test_wrapper.tcl
