...
HD_PWD='D:/Work/OnDeviceAI2/260622_MicroBlaze_GPIO/260622_MicroBlaze_GPIO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GPIO_Test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GPIO_Test_wrapper.tcl -notrace
