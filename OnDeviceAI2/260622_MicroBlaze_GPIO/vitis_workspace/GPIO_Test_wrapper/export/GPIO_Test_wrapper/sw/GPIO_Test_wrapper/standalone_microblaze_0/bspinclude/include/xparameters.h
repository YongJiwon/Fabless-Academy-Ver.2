...
#define XPAR_MICROBLAZE_0_COMPONENT_NAME GPIO_Test_microblaze_0_0
...
#define XPAR_MICROBLAZE_COMPONENT_NAME GPIO_Test_microblaze_0_0
...
#define XPAR_GPIO_NUM_INSTANCES 1
