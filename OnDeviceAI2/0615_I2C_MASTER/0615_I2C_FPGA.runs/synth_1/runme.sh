...
HD_PWD='D:/Work/OnDeviceAI2/0615_I2C_MASTER/0615_I2C_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log master_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source master_top.tcl
