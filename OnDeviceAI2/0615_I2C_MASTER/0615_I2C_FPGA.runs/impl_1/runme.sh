...
HD_PWD='D:/Work/OnDeviceAI2/0615_I2C_MASTER/0615_I2C_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log master_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source master_top.tcl -notrace
