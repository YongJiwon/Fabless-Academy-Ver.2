...
HD_PWD='D:/Work/OnDeviceAI2/final_stop_watch/final_stop_watch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_stopwatch_watch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_stopwatch_watch.tcl
