...
HD_PWD='D:/Work/OnDeviceAI2/final_stop_watch/final_stop_watch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_stopwatch_watch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_stopwatch_watch.tcl -notrace
