...
HD_PWD='D:/Work/OnDeviceAI2/260429_FIFO_UART_Project/260429_FIFO_UART_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_sr04_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_sr04_controller.tcl -notrace
