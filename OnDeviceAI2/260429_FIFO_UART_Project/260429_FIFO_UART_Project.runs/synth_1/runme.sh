...
HD_PWD='D:/Work/OnDeviceAI2/260429_FIFO_UART_Project/260429_FIFO_UART_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_sr04_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_sr04_controller.tcl
