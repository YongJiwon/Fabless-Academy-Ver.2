...
HD_PWD='D:/Work/OnDeviceAI2/counter_10000/counter_10000.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_10000.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_10000.tcl -notrace
