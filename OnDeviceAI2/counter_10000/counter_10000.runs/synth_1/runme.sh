...
HD_PWD='D:/Work/OnDeviceAI2/counter_10000/counter_10000.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_10000.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_10000.tcl
